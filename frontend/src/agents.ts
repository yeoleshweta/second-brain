...
export const AGENTS: AgentDef[] = [
  ...
  },
  {
    id: 'finance',
    intent: 'finance',
    name: 'Chandler (Finance)',
    emoji: FRIENDS_CHARACTERS.chandler.emoji,
    moodEmoji: FRIENDS_CHARACTERS.chandler.mood,
    specialty: 'Finance & Spending',
    tagline: 'Read-only money tracking',
    catchphrase: 'Could I BE any more helpful with money?',
    description: 'Syncs your bank via Plaid, tracks spending, surfaces subscriptions, and writes your weekly financial review. Read-only — never moves money.',
    phase: 5,
    live: true,
    ...
    suggestions: [
      ...
      { label: 'Sync bank data', prompt: 'sync my bank transactions' },
    ],
  },
  {
    id: 'wellness',
